...
URPCore.RegisterServerCallback('garages:getOwnedCars', function(source, cb)
	local ownedCars = {}
...
AddEventHandler('garages:CheckForSpawnVeh', function(veh_id, garageCost)
  ...
  RegisterServerEvent('garages:putcaringarage')
  AddEventHandler('garages:putcaringarage', function()
	if GetCurrentResourceName() == 'garages' then
		Citizen.CreateThread(function()
			Citizen.Wait(1)
			ImpoundCarOut()
