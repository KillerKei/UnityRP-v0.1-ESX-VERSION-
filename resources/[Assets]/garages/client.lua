...
AddEventHandler('playerSpawned', function(spawn)
	if not hasAlreadyJoined then
		TriggerServerEvent('garages:putcaringarage')
	end
...
function ListeVehicule(page)
	...
	ClearMenu()
	local carCount = 0
	URPCore.TriggerServerCallback('garages:getOwnedCars', function(ownedCars)
...
function SpawnVehicle(vehicle, plate, fuelSet, spawnx, spawny, spawx, spawnz)
	...
	URPCore.Game.SpawnVehicle(vehicle.model, {
		...
		--URPCore.Game.SetVehicleProperties(callback_vehicle, vehicle)
	...
	TriggerServerEvent('garages:setVehicleState', plate, false)
end
