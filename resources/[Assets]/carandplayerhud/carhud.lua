...
RegisterNetEvent('urp-voice:focus:set')
AddEventHandler('urp-voice:focus:set', function(hasFocus, hasKeyboard, hasMouse)
...
RegisterNetEvent("urp-hud:changeRange")
AddEventHandler("urp-hud:changeRange", function(pRange)
