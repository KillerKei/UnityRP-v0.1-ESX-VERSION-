...
Citizen.CreateThread(function(); print('Newspaper Starting'); if Config.usingURPCore then; URPCore = nil; PlayerData = {}; Citizen.CreateThread(function()
while URPCore == nil do TriggerEvent('urp:getSharedObject', function(obj) URPCore = obj end); print("loading URPCore"); Citizen.Wait(0); end;
while URPCore.GetPlayerData().job == nil do Citizen.Wait(10); end; PlayerData = URPCore.GetPlayerData(); print("URPCore loaded"); end);
Citizen.CreateThread(function() Citizen.Wait(10000); TriggerEvent("newspaper:off"); TriggerServerEvent("newspaper:update"); print("URPCore-Newspaper by NuketheWhales7#7777 loaded"); end)
