...
URPCore.RegisterServerCallback('urp-license:getLicense', function(source, cb, type)
	GetLicense(type, cb)
end)

URPCore.RegisterServerCallback('urpCheckJob', function(cb)
    ...
    local _player = URPCore.GetPlayerFromId(_source)
...
URPCore.RegisterServerCallback('urp-license:getLicenses', function(source, cb, target)
	GetLicenses(target, cb)
end)


URPCore.RegisterServerCallback('urp-license:checkLicense', function(source, cb, target, type)
	CheckLicense(target, type, cb)
end)

URPCore.RegisterServerCallback('urp-license:getLicensesList', function(source, cb)
	GetLicensesList(cb)
end)