...
local function saveVehicle()
	...
	local myCar = URPCore.Game.GetVehicleProperties(veh)
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("urp-bennys:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("urp-bennys:purchaseSuccessful")
AddEventHandler("urp-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("urp-bennys:purchaseFailed")
AddEventHandler("urp-bennys:purchaseFailed", function()
