...
AddEventHandler('dispatch:clNotify', function(pNotificationData)
  local currentJob = URPCore.GetPlayerData().job.name
...
Citizen.CreateThread(function()
	while true do
        Citizen.Wait(0)
        if (IsControlJustReleased(0, 178) and (URPCore.GetPlayerData().job.name == 'ambulance' or URPCore.GetPlayerData().job.name == 'police') and not exports["urp-ambulancejob"]:GetDeath()) then
...
AddEventHandler('police:panic', function()
      ...
      recipientList = {
		...
		TriggerEvent('urp-alerts:policepanic')
end)
...
AddEventHandler('police:assistance', function()
      ...
      recipientList = {
		...
		TriggerEvent('urp-alerts:assistanceneeded')
end)
...
AddEventHandler("police:1047", function()
    ...
    recipientList = {
      police = "police", ambulance = "ambulance"
		...
		TriggerEvent('urp-alerts:downguy')
end)
...
function AlertGunShot()
    Citizen.CreateThread(function() 
      ...
      TriggerEvent('urp-alerts:gunshot')
...
function CarCrash()
  ...
  TriggerEvent('urp-alerts:vehiclecrash')
...
function AlertCheckLockpick(object)
  ...
  if not DoesEntityExist(targetVehicle) then
    ...
    TriggerEvent('urp-alerts:stolenveh')
  end
end
...
function AlertpersonRobbed(vehicle)
  ...
  TriggerEvent('urp-alerts:robstore')
  Wait(math.random(5000,15000))
...
function AlertCheckRobbery2()
  ...
  TriggerEvent('urp-alerts:robhouse')
  Wait(math.random(5000,15000))
...
function AlertJewelRob()
  ...
  TriggerEvent('urp-alerts:jewrob')
  Wait(math.random(5000,15000))
...
RegisterNetEvent('urp-dispatch:drugjob')
AddEventHandler("urp-dispatch:drugjob",function()
  AlertDrugJob()
end)

RegisterNetEvent('urp-dispatch:bankrobbery')
AddEventHandler("urp-dispatch:bankrobbery",function()
  AlertFleecaRobbery()
end)

RegisterNetEvent('urp-dispatch:jailbreak')
AddEventHandler("urp-dispatch:jailbreak",function()
  AlertJailBreak()
end)

RegisterNetEvent('urp-dispatch:jewelrobbery')
AddEventHandler("urp-dispatch:jewelrobbery",function()
  AlertJewelRob()
  return
end)

RegisterNetEvent('urp-dispatch:houserobbery')
AddEventHandler("urp-dispatch:houserobbery",function()
  AlertCheckRobbery2()
end)

RegisterNetEvent('urp-dispatch:storerobbery')
AddEventHandler("urp-dispatch:storerobbery",function()
  AlertpersonRobbed(vehicle)
end)

RegisterNetEvent('urp-dispatch:carjacking')
AddEventHandler("urp-dispatch:carjacking",function()
  AlertCheckLockpick(object)
end)

RegisterNetEvent('urp-ambulancejob:downplayer')
AddEventHandler("urp-ambulancejob:downplayer",function()
    AlertDeath()
end)
