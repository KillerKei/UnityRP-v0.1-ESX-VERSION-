...
AddEventHandler('urp:playerLoaded', function(spawn)
...
Citizen.CreateThread( function()
	...
	while true do
		...
		if enableSync and not insidebuilding and not inhotel and not robbing and not inhouse and not spawning then 
