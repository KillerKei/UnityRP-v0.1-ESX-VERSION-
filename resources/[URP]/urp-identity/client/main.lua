...
RegisterNetEvent('urp-identity:showRegisterIdentity')
AddEventHandler('urp-identity:showRegisterIdentity', function()
	if not isDead then
		EnableGui(true)
	end
end)
...
RegisterNetEvent('urp-identity:saveID')
AddEventHandler('urp-identity:saveID', function(data)
	myIdentifiers = data
end)
...
RegisterNUICallback('register', function(data, cb)
    ...
    if reason == "" then
		...
		DoScreenFadeIn(1000)
		Wait(1000)
		TriggerServerEvent('urp-identity:setIdentity', data, myIdentifiers)
        EnableGui(false)
		TriggerEvent('urp-clothing:defaultReset', myIdentifiers.id)
		Wait(10000)
