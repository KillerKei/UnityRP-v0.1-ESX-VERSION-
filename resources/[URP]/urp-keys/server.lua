...
URPCore.RegisterServerCallback('urp-keys:checkOwner', function(source, cb, plate)
...
AddEventHandler('garage:giveKey', function(target, plate)
  ...
  local xPlayer = URPCore.GetPlayerFromId(targetSource)
  local ident = xPlayer.getIdentifier()
  local xPlayer2 = URPCore.GetPlayerFromId(source)
