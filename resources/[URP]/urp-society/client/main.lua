...
function EnableSocietyMoneyHUDElement()
	...
	URPCore.UI.HUD.RegisterElement('society_money', 3, 0, societyMoneyHUDElementTpl, {
		money = 0
	})
end

function DisableSocietyMoneyHUDElement()
	URPCore.UI.HUD.RemoveElement('society_money')
end

function UpdateSocietyMoneyHUDElement(money)
	URPCore.UI.HUD.UpdateElement('society_money', {
		money = money
	})
end
...
function OpenBossMenu(society, close, options)
	...
	URPCore.TriggerServerCallback('urp-society:isBoss', function(result)
		isBoss = result
	end, society)
	...
	URPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'boss_actions_' .. society,
	{
		title    = _U('boss_menu'),
		align    = 'top-left',
		elements = elements
		...
		if data.current.value == 'withdraw_society_money' then
			...
			URPCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('urp-society:withdrawMoney', society, amount)
				end
		...
		elseif data.current.value == 'deposit_money' then
			...
			URPCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('urp-society:depositMoney', society, amount)
				end
		...
		elseif data.current.value == 'wash_money' then
			...
			URPCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'wash_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('urp-society:washMoney', society, amount)
				end
...
function OpenManageEmployeesMenu(society)
	...
	URPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_employees_' .. society,
	{
...
function OpenEmployeeList(society)
	...
	URPCore.TriggerServerCallback('urp-society:getEmployees', function(employees)
		...
		URPCore.UI.Menu.Open('list', GetCurrentResourceName(), 'employee_list_' .. society, elements, function(data, menu)
			...
			if data.value == 'fire' then
				...
				URPCore.TriggerServerCallback('urp-society:setJob', function()
					OpenEmployeeList(society)
...
function OpenRecruitMenu(society)
	...
	URPCore.TriggerServerCallback('urp-society:getOnlinePlayers', function(players)
		...
		URPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_' .. society,
		{
			title    = _U('recruiting'),
			align    = 'top-left',
			elements = elements
			...
			URPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_confirm_' .. society,
			{
...
function OpenPromoteMenu(society, employee)
	...
	URPCore.TriggerServerCallback('urp-society:getJob', function(job)
		...
		URPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'promote_employee_' .. society,
		{
...
function OpenManageGradesMenu(society)
	...
	URPCore.TriggerServerCallback('urp-society:getJob', function(job)
		...
		URPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_grades_' .. society,
		{
			...
			URPCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'manage_grades_amount_' .. society,
			{
				...
				elseif amount > Config.MaxSalary then
					...
					URPCore.TriggerServerCallback('urp-society:setJobSalary', function()
						OpenManageGradesMenu(society)
...
AddEventHandler('urp:playerLoaded', function(xPlayer)
	...
	if PlayerData.job.grade_name == 'boss' then
		...
		URPCore.TriggerServerCallback('urp-society:getSocietyMoney', function(money)
...
RegisterNetEvent('urp-addonaccount:setMoney')
AddEventHandler('urp-addonaccount:setMoney', function(society, money)
	if PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss' and 'society_' .. PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)

AddEventHandler('urp-society:openBossMenu', function(society, close, options)
